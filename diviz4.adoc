...
image::https://github.com/kkakama/J-XMCDA/tree/DivizIssue/img/interfaceDiviz1.png[height=100]
...
Ci-dessous le résultat obtenu : 
 ...
 = Include
image::J-XMCDA/img/image2.png[height=100]
...
*Positive Flows :* 
 ...
 = Include
image::J-XMCDA/img/image3.png[height=100] 
...
Nous avons constaté qu’en exécutant les modules diviz dénotés “J-XMCDA” nous avions l’exception suivante : 
  ...
  = Include
image::J-XMCDA/img/image4.png[height=100]
